...
const UploadComponent = () =>
{
  ...
  return (
    <>
      <div
        className='relative flex justify-center items-center flex-col rounded-lg w-full shadow-lg bg-codeWhite h-[200px] cursor-pointer text-center mx-auto mb-6 hover:bg-secondary transition-colors ease duration-300'
        onDrop={handleDrop}
        ...
        </div>
        {
          file.preview && (
            <div className='absolute top-0 left-0 w-full h-full rounded-lg'>
              ...
              />
              <p className='text-left bg-codeWhite text-codeBlue font-Poppins text-base font-normal rounded-b-lg p-2'>{file.name}</p>
            </div>
          )
        }
      </div>
